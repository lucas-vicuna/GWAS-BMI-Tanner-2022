...
f22 <- paste0('tanner34/output/chr',chr,'_tanner34.txt')
...
f4 <- paste0('tanner34/output_conjunto/chr',chr,'_conjunto.txt')
f5 <- paste0('tanner34/output_conjunto/chr',chr,'_conjuntofailed.txt')
