...
f1 <- 'data/educacion_madre2.csv'

file3 <- paste0('/data/genetica/tomas_localancestry/gocs_pel_ibs_pel95_phen904/rfmix15.chr',chr,'.stats.phen.pel_ibs.txt')
file4 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output2/AgeAR_i_chr',chr,'.txt')
file5 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output2/BMIAR_i_chr',chr,'.txt')
file6 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output2/AgeAR_ii_chr',chr,'.txt')
file7 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output2/BMIAR_ii_chr',chr,'.txt')
file8 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output2/chr',chr,'_AR_failed.txt')
