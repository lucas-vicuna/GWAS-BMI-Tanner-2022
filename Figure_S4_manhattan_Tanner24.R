pdf("/data/lucas/tanner/figures/manhattans_survival_MF_tanner24.pdf",  
    width=6, height=5.5)
...
chrs=fread("/data/genetica/Tanner/tanner24_boys_survival.csv",header=T)
colnames(chrs)=c("CHR","SNP","Beta","std_error","Z_val","P_val")
snps=fread("/data/genetica/Tanner/snps_filtrados_tanner24_boys_survival.csv",
           header=T)
...
mtext(side = 3, text = expression(italic("RASGRP3")), 
      line = 1, adj = 0.15, padj = 4.2, las = 1, cex=0.7, col="deepskyblue4") 
mtext(side = 3, text = expression(italic("RASGRP3")), 
      line = 1, adj = 0.15, padj = 6.3, las = 1, cex=0.7, col="deepskyblue4") 
mtext(side = 3, text = expression(italic("TMEM182")), 
      line = 1, adj = 0.17, padj = 8.2, las = 1, cex=0.7, col="deepskyblue4") 
mtext(side = 3, text = expression(italic("RP11-1263C18.1")), 
      line = 1, adj = 0.33, padj = 6.3, las = 1, cex=0.7, col="deepskyblue4") 
mtext(side = 3, text = expression(italic("RP11-563J2.2")), 
      line = 1, adj = 0.65, padj = 7.9, las = 1, cex=0.7, col="deepskyblue4") 
mtext(side = 3, text = expression(italic("RBFOX1")), 
      line = 1, adj = 0.90, padj = 6.3, las = 1, cex=0.7, col="deepskyblue4") 
...
chrs=fread("/data/genetica/Tanner/tanner24_girls_survival.csv",header=T)
colnames(chrs)=c("CHR","SNP","Beta","std_error","Z_val","P_val")
snps=fread("/data/genetica/Tanner/snps_filtrados_tanner24_girls_survival.csv",
           header=T)
chrs = semi_join(chrs,snps,c("CHR","SNP"))
