...
file <- paste0('Adiposity_Rebound/data/data_AR_trans.tsv')
file2 <- paste0('detail/chr',chr,'_SNP_selected.tsv')
file3 <- paste0('/data/genetica/tomas_localancestry/gocs_pel_ibs_pel95_phen904/rfmix15.chr',chr,'.stats.phen.pel_ibs.txt')
file6 <- paste0('Adiposity_Rebound/output Age_AR2/chr',chr,'_Age_AR2.txt')
file7 <- paste0('Adiposity_Rebound/output BMI_AR2/chr',chr,'_BMI_AR2.txt')
file8 <- paste0('Adiposity_Rebound/output Age_AR/chr',chr,'_AR_failed.txt')
