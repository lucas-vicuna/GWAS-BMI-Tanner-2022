...
df1f <- read_csv('bmi/two_stage_weibull/data/girls_bmi_T23.csv')
df1m <- read_csv('bmi/two_stage_weibull/data/boys_bmi_T23.csv')

f2 <- paste0('bmi/detail/chr',chr,'_SNP_selected.tsv')
f22 <- paste0('tanner23/output/chr',chr,'_tanner23.txt')
...
f4 <- paste0('tanner23/output_conjunto/chr',chr,'_conjunto.txt')
f5 <- paste0('tanner23/output_conjunto/chr',chr,'_conjuntofailed.txt')
