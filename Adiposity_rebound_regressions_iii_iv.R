...
file <- paste0('bmi/Adiposity_Rebound/data/data_AR_trans.tsv')
file2 <- paste0('bmi/detail/chr',chr,'_SNP_selected.tsv')

f12 <- 'data/educacion_madre2.csv'
f13 <- 'data/GOCS_904PCA.txt'

file3 <- paste0('/data/genetica/tomas_localancestry/gocs_pel_ibs_pel95_phen904/rfmix15.chr',chr,'.stats.phen.pel_ibs.txt')
file4 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output3/AgeAR_iii_chr',chr,'.txt')
file5 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output3/BMIAR_iii_chr',chr,'.txt')
file6 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output3/AgeAR_iv_chr',chr,'.txt')
file7 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output3/BMIAR_iv_chr',chr,'.txt')
file8 <- paste0('bmi/Adiposity_Rebound/nuevos_analisis/output3/chr',chr,'_AR_failed.txt')
...
for (i in 1:k){
  ...
  tryCatch({
    ...
    #iii Con ancestría local, sin ancestría global, con primeros 10 PCs, con nivel educacional madres
    ...
    #iv Sin ancestría local, sin ancestría global, con primeros 10 PCs, con nivel educacional madres
